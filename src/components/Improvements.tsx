...
const Quotes: React.ForwardRefRenderFunction<HTMLFormElement, ImprovProps> =
	function (props: ImprovProps, ref: LegacyRef<HTMLFormElement>) {
		...
		return (
			<form
				ref={ref}
				className="grid 2xl:grid-cols-2 items-center gap-4 mx-8 lg:mx-24 p-4  min-w-[300px] lg:min-w-[600px] max-w-[600px] min-h-[260px] max-h-[700px bg-white rounded-xl"
				onSubmit={onSubmit}
			>
				{!submitted && (
					<>
				...
				{submitted && !loading && (
					<div className="grid grid-cols-2 mt-4 col-span-2">
						...
						<div className="grid grid-cols-2 justify-center col-span-2 mt-6 gap-2">
							<Button
